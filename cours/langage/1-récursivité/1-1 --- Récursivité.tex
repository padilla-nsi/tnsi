...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/papier_eleve/papier_eleve_ico_langage}\ttfamily\scshape Langage}\fancyhead[C]{\bfseries\MakeUppercase{1-1 --- Récursivité}}\fancyhead[R]{\monthyeardate\today}
...
\section{Chap. 1 --- Récursivité}\label{chap.-1-ruxe9cursivituxe9}}
    ...
    \hypertarget{probluxe8me-de-la-some-des-n-premiers-entiers}{%
\subsection{\texorpdfstring{1.1 --- Problème de la some des \(n\)
premiers
entiers}{1.1 --- Problème de la some des n premiers entiers}}\label{probluxe8me-de-la-some-des-n-premiers-entiers}}
...
Utilisons maintenant cette illustration pour modéliser quelques exemples
de calculs.
