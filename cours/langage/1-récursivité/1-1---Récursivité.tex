...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/papier_eleve/papier_eleve_ico_langage}\ttfamily\scshape Langage}\fancyhead[C]{\bfseries\MakeUppercase{1-1---Récursivité}}\fancyhead[C]{\bfseries\MakeUppercase{1 --- Récursivité}}\fancyhead[R]{\monthyeardate\today}
...
\PY{c+c1}{\PYZsh{} programmation avec tests}
\PY{c+c1}{\PYZsh{} import doctest}
...
\PY{c+c1}{\PYZsh{} programmation tests}
\PY{c+c1}{\PYZsh{} doctest.testmod()}
\end{Verbatim}
\end{tcolorbox}
    }
...
\PY{k}{def} \PY{n+nf}{nombre\PYZus{}de\PYZus{}chiffre}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Nombre de chiffre d\PYZsq{}un nombre entier}
...
\(u_n = 1\). Cette conjecture défie toujours les mathématiciens.
    ...
    En appelant \(carre(x)\) la fonction qui a \(x\) associe \(x \times x\),
on peut utiliser une autre définition de la fonction mathématique
\(puissance(x,n)\) : \[
\begin{array}{ll}
& puissance(x,n) = \\ 
& \qquad\left\{
