...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/pdf_solution/papier_eleve_ico_langage}\ttfamily\scshape Langage}\fancyhead[C]{\bfseries\MakeUppercase{2-2b---Modularité-tableau}}\fancyhead[C]{\bfseries\MakeUppercase{2 --- Modularité}}\fancyhead[R]{\monthyeardate\today}
...
anniversaires}\label{un-exemple-le-paradoxe-des-anniversaires}}
    ...
    \hypertarget{groupe-2-les-tableaux}{%
\subsubsection{Groupe 2 --- les tableaux}\label{groupe-2-les-tableaux}}
...
\item
  Quel est le but de la commande \texttt{s.append(x)} ?
\item
