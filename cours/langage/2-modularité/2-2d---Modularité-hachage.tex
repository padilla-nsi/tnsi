...
anniversaires}\label{un-exemple-le-paradoxe-des-anniversaires}}
    ...
    \hypertarget{groupe-4-la-table-de-hachage}{%
\subsubsection{Groupe 4 --- la table de
hachage}\label{groupe-4-la-table-de-hachage}}
...
\PY{k}{def} \PY{n+nf}{contient\PYZus{}doublon}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{s} \PY{o}{=} \PY{p}{[}\PY{p}{[}\PY{p}{]} \PY{k}{for} \PY{n}{\PYZus{}} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{23}\PY{p}{)}\PY{p}{]}
    \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{t}\PY{p}{:}
        \PY{k}{if} \PY{n}{x} \PY{o+ow}{in} \PY{n}{s}\PY{p}{[}\PY{n}{x} \PY{o}{\PYZpc{}} \PY{l+m+mi}{23}\PY{p}{]}\PY{p}{:}
            \PY{k}{return} \PY{k+kc}{True}
        \PY{n}{s}\PY{p}{[}\PY{n}{x} \PY{o}{\PYZpc{}} \PY{l+m+mi}{23}\PY{p}{]}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{x}\PY{p}{)}
