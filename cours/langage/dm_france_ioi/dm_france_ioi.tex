...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/papier_eleve/papier_eleve_ico_langage}\ttfamily\scshape Langage}\fancyhead[C]{\bfseries\MakeUppercase{dm_france_ioi}}\fancyhead[C]{\bfseries\MakeUppercase{DM TNSI --- France IOI}}\fancyhead[R]{\monthyeardate\today}
...
% \maketitle
    ...
    \hypertarget{france-ioi}{%
\section{France IOI}\label{france-ioi}}

    Objectifs à atteindre sur France IOI pour le \textbf{8 novembre 2022}
(rentrée des vacances de la Toussaint). Attention, cela demande un très
gros travail (entre 15 et 20h !) et donc de l'\textbf{organisation}.
\begin{eleve}
    \textbf{Niveau 1 (33 problèmes)}

\begin{itemize}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/K}]
  lecture de l'entrée (10 problèmes)
  \end{description}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/L}]
  structures imbriquées (8 problèmes)
  \end{description}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/M}]
  conditions avancées (10 problèmes)
  \end{description}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/N}]
  répétitions conditionnées (5 problèmes)
  \end{description}
\end{itemize}

\textbf{Niveau 2 (44 problèmes)}

\begin{itemize}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/O}]
  Nombres à virgules et autres outils (11 problèmes)
  \end{description}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/P}]
  Découverte des tableaux (10 problèmes)
  \end{description}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/Q}]
  Chaînes de caractères (14 problèmes)
  \end{description}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/R}]
  Fonctions (9 problèmes)
  \end{description}
\end{itemize}

\textbf{Niveau 3 (5 problèmes)}

\begin{itemize}
\item
  \begin{description}
  \tightlist
  \item[\url{http://pa.dilla.fr/S}]
  déblocage niveau 3 (5 problèmes)
  \end{description}
\end{itemize}
