...
\end{tcolorbox}
    ...
    \hypertarget{ruxe9aliser-une-file-avec-deux-piles}{%
\subsection{6.8 --- Réaliser une file avec deux
piles}\label{ruxe9aliser-une-file-avec-deux-piles}}
...
\PY{l+s+sd}{        Exemples et tests:}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} f = File()}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} print(type(f.entree))}
\PY{l+s+sd}{        \PYZlt{}class \PYZsq{}\PYZus{}\PYZus{}main\PYZus{}\PYZus{}.Pile\PYZsq{}\PYZgt{}}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} print(type(f.sortie))}
\PY{l+s+sd}{        \PYZlt{}class \PYZsq{}\PYZus{}\PYZus{}main\PYZus{}\PYZus{}.Pile\PYZsq{}\PYZgt{}}
\PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{entree} \PY{o}{=} \PY{n}{Pile}\PY{p}{(}\PY{p}{)}
        \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sortie} \PY{o}{=} \PY{n}{Pile}\PY{p}{(}\PY{p}{)}
...
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} print(f.est\PYZus{}vide())}
\PY{l+s+sd}{        True}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} f.entree.empiler(1)}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} print(f.est\PYZus{}vide())}
\PY{l+s+sd}{        False}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} f.entree.depiler()}
\PY{l+s+sd}{        1}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} f.sortie.empiler(1)}
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} print(f.est\PYZus{}vide())}
\PY{l+s+sd}{        False}
\PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{k}{return} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{entree}\PY{o}{.}\PY{n}{est\PYZus{}vide}\PY{p}{(}\PY{p}{)} \PY{o+ow}{and} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sortie}\PY{o}{.}\PY{n}{est\PYZus{}vide}\PY{p}{(}\PY{p}{)}
...
\PY{l+s+sd}{        1}
\PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{entree}\PY{o}{.}\PY{n}{empiler}\PY{p}{(}\PY{n}{valeur}\PY{p}{)}
...
\PY{l+s+sd}{        \PYZgt{}\PYZgt{}\PYZgt{} f.defiler()}
\PY{l+s+sd}{        Traceback (most recent call last):}
\PY{l+s+sd}{        IndexError: defiler sur file vide}
\PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{k}{if} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sortie}\PY{o}{.}\PY{n}{est\PYZus{}vide}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{k}{while} \PY{o+ow}{not} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{entree}\PY{o}{.}\PY{n}{est\PYZus{}vide}\PY{p}{(}\PY{p}{)}\PY{p}{:}
                \PY{n}{valeur} \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{entree}\PY{o}{.}\PY{n}{depiler}\PY{p}{(}\PY{p}{)}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sortie}\PY{o}{.}\PY{n}{empiler}\PY{p}{(}\PY{n}{valeur}\PY{p}{)}
        
        \PY{k}{if} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sortie}\PY{o}{.}\PY{n}{est\PYZus{}vide}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{k}{raise} \PY{n+ne}{IndexError}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{defiler sur file vide}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

        \PY{k}{return} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sortie}\PY{o}{.}\PY{n}{depiler}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
    }
