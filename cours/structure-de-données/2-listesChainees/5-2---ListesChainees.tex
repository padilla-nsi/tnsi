...
\setcounter{secnumdepth}{0} % Turns off numbering for sections
    ...
    \geometry{a4paper,tmargin=3cm,bmargin=2cm,lmargin=1cm,rmargin=1cm}\fancyhead[L]{Thème à définir}\fancyhead[L]{\adjustimage{height=1cm, valign=m}{/home/bouscadilla/Documents/Code/nbconvert/template/latex/pdf_solution/papier_eleve_ico_structure}\ttfamily\scshape Struct.de données}\fancyhead[C]{\bfseries\MakeUppercase{5-2---ListesChainees}}\fancyhead[C]{\bfseries\MakeUppercase{3 --- P.O.O.}}\fancyhead[R]{\monthyeardate\today}
...
valeur stockée et l'adresse mémoire du maillon suivant.
